...
threshold_img = cv2.threshold(gray_image, 0, 255, cv2.THRESH_BINARY | cv2.THRESH_OTSU)[
    1
]
...
# with open('results.txt',  'w', newline="") as final_file:
...
for word in details["text"]:
    ...
    if (last_word != "" and word == "") or (word == details["text"][-1]):
        ...
        # final_file.writelines(" ".join(word_list))
        word_list = []

print(parse_text)
with open("tesseract_result.txt", "w", newline="") as file:
